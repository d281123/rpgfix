...
let handler = async (m, { text, usedPrefix, command }) => {
  ...
  let res = await fetch(`https://apikey-bear3.herokuapp.com/api/maker/skatch?apikey=https://youtu.be/JNuiRPRysuk&url=https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbmrYfgiRt1lLwNgRMgMbID62qH3EQ2T1c6RUJEQMcoCWKqVVxAg7R_LfM&s=10`)
